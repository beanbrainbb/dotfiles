...
class Themer:
    def __init__(self, path):
        ...
        self._layouts = {
            ...
            'border_normal_fiexed': self._theme['color4'],
        ...
        self._widgets = {
            ...
            'rounded': False,
            'borderwidth': 2,
            'border_color': self._theme["color9"],
            'border': self._theme['color4'],
            'active': self._theme["foreground"],
            'color_active': self._theme['color14'],
            'color_inactive': self._theme['color9'],
            'color_break': self._theme['color10'],
            'inactive': self._theme['foreground'],
            'this_current_screen_border': self._theme['color4'],
            'other_current_screen_border': self._theme['foreground'],
            'this_screen_border': self._theme['color14'],
            'other_screen_border': self._theme['color4'],
            'opacity': 0.5,
            # Get just the font name (second field) no more
            'font': findall('\-\w*\-([^-]*)\-.*', self._theme['font'])[0],
            'fontsize': 11,
            'fontshadow': self._theme['background'],
